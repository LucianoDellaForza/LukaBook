...
import com.chelios.lukabook.ui.main.viewmodels.CreatePostViewModel
import com.chelios.lukabook.ui.slideUpViews
...
class CreatePostFragment : Fragment(R.layout.fragment_create_post) {
    ...
    private fun subscribeToObservers() {
        ...
        viewModel.createPostStatus.observe(viewLifecycleOwner, EventObserver(
            ...
            createPostProgressBar.isVisible = false
            findNavController().popBackStack() //when user posts something, no reason to stay in CreatePostFragment
        })
    }
}